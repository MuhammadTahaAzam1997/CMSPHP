...
<h3><?php echo "Welcome ". $_SESSION['username']?>! Now you have right to access:</h3>
<hr>

<div id="block_container">
    <div id=block1 class="card" style="width: 18rem;">
  <img src="https://img.icons8.com/wired/64/000000/edit-user-male.png" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Student's Registration</h5>
    <p class="card-text">Click the button below to register a new student.</p>
    <a href="studentsregister.php" class="btn btn-primary">Register</a>
    </div>
  </div>
  
<div id =block2 class="Search Student" style="width: 18rem;">
